<?php /* Template Name: Land Developement Page */ get_header('2'); ?>
	...
	<main role="main">
		<!-- section -->
                <section class="mainContent">
                    ...
                    <div class="headerBanner banner-4">
			<h1><?php the_title(); ?></h1>
                        <p>EXCITING, VIBRANT MOVE-IN READY COMMUNITIES</p>
                    </div> 
                ...
                <div class="FocusArea">
                    ...
                    <p>WHAT WE DO IN COMMERCIAL CONSTRUCTION</p>
                         ...
                         <?php    
                              $args = array( 'post_type' => 'focus','cat' => 10, 'order' => 'ASC',  'posts_per_page' => '3' );  
                ...
                <div class="commercialIcons">
                    <div class="IconArea">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-16.png" alt="icon-10" >
                        
                                <h3>
                                    LARGE CONSTRUCTION<BR />
                                    PROJECT EXPERIENCE
                                </h3>
                        
                    </div>
                    <div class="IconArea">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-17.png" alt="icon-11" >
                        <h3>
                            SAFE, PROFFESIONAL<BR />
                            WORK CREW
                        </h3>
                    </div>
                    <div class="IconArea">
                        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-18.png" alt="icon-12" >
                        <h3>
