...
function create_post_type_html5()
{
    ...
    register_post_type('services', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'not_found' => __('No Servicess found', 'services'),
    ...
    register_post_type('testimonials', // Register Custom Post Type
        ...
        'labels' => array(
            ...
            'singular_name' => __('Core Partner', 'testimonials'),
    ...
    register_taxonomy_for_object_type('category', 'commercial'); // Register Taxonomies for Category
    register_taxonomy_for_object_type('post_tag', 'commercial');
    register_post_type('commercial', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Commercial', 'commercial'), // Rename these to suit
            'singular_name' => __('Core Partner', 'commercial'),
            'add_new' => __('Add New', 'commercial'),
            'add_new_item' => __('Add New Commercial', 'commercial'),
            'edit' => __('Edit', 'commercial'),
            'edit_item' => __('Edit Commercial', 'commercial'),
            'new_item' => __('New Commercial', 'commercial'),
            'view' => __('View Commercial', 'commercial'),
            'view_item' => __('View Commercial', 'commercial'),
            'search_items' => __('Search Commercial', 'commercial'),
            'not_found' => __('No Commercials found', 'commercial'),
            'not_found_in_trash' => __('No Commercials found in Trash', 'commercial')
        ),
    ...
    register_post_type('team', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Our Team', 'team'), // Rename these to suit
            'singular_name' => __('Area Of Focus', 'team'),
            'add_new' => __('Add New', 'team'),
            'add_new_item' => __('Add New Our Team', 'team'),
            'edit' => __('Edit', 'team'),
            'edit_item' => __('Edit Our Team', 'team'),
            'new_item' => __('New Our Team', 'team'),
            'view' => __('View Our Team', 'team'),
            'view_item' => __('View Our Team', 'team'),
            'search_items' => __('Search Our Team', 'team'),
            'not_found' => __('No Our Teams found', 'team'),
            'not_found_in_trash' => __('No Our Team found in Trash', 'team')
        ),
